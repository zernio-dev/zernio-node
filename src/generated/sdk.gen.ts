 ...
 *
 */
export const getAnalyticsDelta = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<GetAnalyticsDeltaData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAnalyticsDeltaResponse, GetAnalyticsDeltaError, ThrowOnError>({
        ...options,
        url: '/v1/analytics/delta'
    });
};
 ...
 *
 * **3. Content-hash dedup (24-hour window).**
...
export const requestWhatsAppVerificationCode = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RequestWhatsAppVerificationCodeData, ThrowOnError>) => {
    return (options?.client ?? client).post<RequestWhatsAppVerificationCodeResponse, RequestWhatsAppVerificationCodeError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/whatsapp/request-code'
    });
};
 ...
 *
 */
export const verifyWhatsAppNumber = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<VerifyWhatsAppNumberData, ThrowOnError>) => {
    return (options?.client ?? client).post<VerifyWhatsAppNumberResponse, VerifyWhatsAppNumberError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/whatsapp/verify-code'
    });
};
 ...
 *
 */
export const getAccountPosts = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetAccountPostsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAccountPostsResponse, GetAccountPostsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/posts'
    });
};
 ...
 */
export const listTikTokCommercialMusic = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListTikTokCommercialMusicData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListTikTokCommercialMusicResponse, ListTikTokCommercialMusicError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/tiktok/commercial-music'
    });
};
 ...
 */
export const searchTikTokLocations = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SearchTikTokLocationsData, ThrowOnError>) => {
    return (options?.client ?? client).get<SearchTikTokLocationsResponse, SearchTikTokLocationsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/tiktok/locations'
    });
};
...
export const completeMetaAdsBusinessLogin = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CompleteMetaAdsBusinessLoginData, ThrowOnError>) => {
    return (options?.client ?? client).get<void, unknown, ThrowOnError>({
        ...options,
        url: '/v1/connect/meta-ads/callback'
    });
};
 ...
 *
 */
export const connectShopifyWithToken = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ConnectShopifyWithTokenData, ThrowOnError>) => {
    return (options?.client ?? client).post<ConnectShopifyWithTokenResponse, ConnectShopifyWithTokenError, ThrowOnError>({
        ...options,
        url: '/v1/connect/shopify/token'
    });
};
 ...
 *
 */
export const getWordPressAuthUrl = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetWordPressAuthUrlData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetWordPressAuthUrlResponse, GetWordPressAuthUrlError, ThrowOnError>({
        ...options,
        url: '/v1/connect/wordpress'
    });
};
 ...
 *
 */
export const connectWordPressWithApplicationPassword = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ConnectWordPressWithApplicationPasswordData, ThrowOnError>) => {
    return (options?.client ?? client).post<ConnectWordPressWithApplicationPasswordResponse, ConnectWordPressWithApplicationPasswordError, ThrowOnError>({
        ...options,
        url: '/v1/connect/wordpress/token'
    });
};
 ...
 *
 */
export const getGoogleBusinessReview = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetGoogleBusinessReviewData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetGoogleBusinessReviewResponse, GetGoogleBusinessReviewError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/gmb-reviews/{reviewId}'
    });
};
 ...
 *
 */
export const connectWhatsAppEmbeddedSignup = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ConnectWhatsAppEmbeddedSignupData, ThrowOnError>) => {
    return (options?.client ?? client).post<ConnectWhatsAppEmbeddedSignupResponse, ConnectWhatsAppEmbeddedSignupError, ThrowOnError>({
        ...options,
        url: '/v1/connect/whatsapp/embedded-signup'
    });
};
 ...
 *
 */
export const getWhatsAppSdkConfig = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<GetWhatsAppSdkConfigData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetWhatsAppSdkConfigResponse, GetWhatsAppSdkConfigError, ThrowOnError>({
        ...options,
        url: '/v1/connect/whatsapp/sdk-config'
    });
};
 ...
 *
 */
export const listSlackChannels = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListSlackChannelsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListSlackChannelsResponse, ListSlackChannelsError, ThrowOnError>({
        ...options,
        url: '/v1/connect/slack'
    });
};
 ...
 */
export const connectSlackChannel = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ConnectSlackChannelData, ThrowOnError>) => {
    return (options?.client ?? client).post<ConnectSlackChannelResponse, ConnectSlackChannelError, ThrowOnError>({
        ...options,
        url: '/v1/connect/slack'
    });
};
 ...
 *
 */
export const getPageWebhookSubscription = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetPageWebhookSubscriptionData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetPageWebhookSubscriptionResponse, GetPageWebhookSubscriptionError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/webhook-subscription'
    });
};
 ...
 *
 */
export const resyncPageWebhookSubscription = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ResyncPageWebhookSubscriptionData, ThrowOnError>) => {
    return (options?.client ?? client).post<ResyncPageWebhookSubscriptionResponse, ResyncPageWebhookSubscriptionError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/webhook-subscription'
    });
};
 ...
 *
 */
export const getYoutubeCaptions = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetYoutubeCaptionsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetYoutubeCaptionsResponse, GetYoutubeCaptionsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/youtube-captions'
    });
};
 ...
 *
 */
export const createYoutubePlaylist = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateYoutubePlaylistData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateYoutubePlaylistResponse, CreateYoutubePlaylistError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/youtube-playlists'
    });
};
 ...
 */
export const getBlueskySettings = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBlueskySettingsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBlueskySettingsResponse, GetBlueskySettingsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/bluesky-settings'
    });
};
 ...
 */
export const updateBlueskySettings = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateBlueskySettingsData, ThrowOnError>) => {
    return (options?.client ?? client).patch<UpdateBlueskySettingsResponse, UpdateBlueskySettingsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/bluesky-settings'
    });
};
 ...
 *
 */
export const redeliverWebhookEvent = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RedeliverWebhookEventData, ThrowOnError>) => {
    return (options?.client ?? client).post<RedeliverWebhookEventResponse, RedeliverWebhookEventError, ThrowOnError>({
        ...options,
        url: '/v1/webhooks/logs/redeliver'
    });
};
 ...
 *
 */
export const setConversationThreadControl = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SetConversationThreadControlData, ThrowOnError>) => {
    return (options?.client ?? client).post<SetConversationThreadControlResponse, SetConversationThreadControlError, ThrowOnError>({
        ...options,
        url: '/v1/inbox/conversations/{conversationId}/thread-control'
    });
};
 ...
 *
 */
export const pinInboxComment = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<PinInboxCommentData, ThrowOnError>) => {
    return (options?.client ?? client).post<PinInboxCommentResponse, PinInboxCommentError, ThrowOnError>({
        ...options,
        url: '/v1/inbox/comments/{postId}/{commentId}/pin'
    });
};
 ...
 *
 */
export const unpinInboxComment = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UnpinInboxCommentData, ThrowOnError>) => {
    return (options?.client ?? client).delete<UnpinInboxCommentResponse, UnpinInboxCommentError, ThrowOnError>({
        ...options,
        url: '/v1/inbox/comments/{postId}/{commentId}/pin'
    });
};
 ...
 *
 */
export const getWhatsAppTemplateById = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetWhatsAppTemplateByIdData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetWhatsAppTemplateByIdResponse, GetWhatsAppTemplateByIdError, ThrowOnError>({
        ...options,
        url: '/v1/whatsapp/templates/id/{templateId}'
    });
};
 ...
 *
 */
export const updateWhatsAppTemplateById = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateWhatsAppTemplateByIdData, ThrowOnError>) => {
    return (options?.client ?? client).patch<UpdateWhatsAppTemplateByIdResponse, UpdateWhatsAppTemplateByIdError, ThrowOnError>({
        ...options,
        url: '/v1/whatsapp/templates/id/{templateId}'
    });
};
 ...
 *
 */
export const deleteWhatsAppTemplateById = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteWhatsAppTemplateByIdData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteWhatsAppTemplateByIdResponse, DeleteWhatsAppTemplateByIdError, ThrowOnError>({
        ...options,
        url: '/v1/whatsapp/templates/id/{templateId}'
    });
};
 ...
 */
export const listImessageSenders = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<ListImessageSendersResponse, ListImessageSendersError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/senders'
    });
};
...
export const registerImessageSender = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RegisterImessageSenderData, ThrowOnError>) => {
    return (options?.client ?? client).post<RegisterImessageSenderResponse, RegisterImessageSenderError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/senders'
    });
};
 ...
 */
export const listImessageSenderOrders = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<ListImessageSenderOrdersData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListImessageSenderOrdersResponse, ListImessageSenderOrdersError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/senders/order'
    });
};
...
export const orderImessageSender = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<OrderImessageSenderData, ThrowOnError>) => {
    return (options?.client ?? client).post<OrderImessageSenderResponse, OrderImessageSenderError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/senders/order'
    });
};
 ...
 */
export const getImessageSender = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetImessageSenderData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetImessageSenderResponse, GetImessageSenderError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/senders/{senderId}'
    });
};
 ...
 */
export const updateImessageSender = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateImessageSenderData, ThrowOnError>) => {
    return (options?.client ?? client).patch<UpdateImessageSenderResponse, UpdateImessageSenderError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/senders/{senderId}'
    });
};
...
export const cancelImessageSender = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CancelImessageSenderData, ThrowOnError>) => {
    return (options?.client ?? client).delete<CancelImessageSenderResponse, CancelImessageSenderError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/senders/{senderId}'
    });
};
 ...
 */
export const listImessageAudience = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<ListImessageAudienceData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListImessageAudienceResponse, ListImessageAudienceError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/audience'
    });
};
 ...
 */
export const setImessageSubscription = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SetImessageSubscriptionData, ThrowOnError>) => {
    return (options?.client ?? client).post<SetImessageSubscriptionResponse, SetImessageSubscriptionError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/audience/subscription'
    });
};
 ...
 *
 */
export const createImessageOptInLink = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateImessageOptInLinkData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateImessageOptInLinkResponse, CreateImessageOptInLinkError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/senders/{senderId}/opt-in-links'
    });
};
 ...
 *
 */
export const listImessageAvailableNumbers = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<ListImessageAvailableNumbersData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListImessageAvailableNumbersResponse, ListImessageAvailableNumbersError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/senders/available-numbers'
    });
};
 ...
 */
export const reserveImessageAvailableNumber = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ReserveImessageAvailableNumberData, ThrowOnError>) => {
    return (options?.client ?? client).post<ReserveImessageAvailableNumberResponse, ReserveImessageAvailableNumberError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/senders/available-numbers/{numberId}/reserve'
    });
};
 ...
 *
 */
export const createImessageGroup = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateImessageGroupData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateImessageGroupResponse, CreateImessageGroupError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/groups'
    });
};
 ...
 */
export const getImessageGroup = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetImessageGroupData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetImessageGroupResponse, GetImessageGroupError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/groups/{conversationId}'
    });
};
 ...
 */
export const updateImessageGroup = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateImessageGroupData, ThrowOnError>) => {
    return (options?.client ?? client).patch<UpdateImessageGroupResponse, UpdateImessageGroupError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/groups/{conversationId}'
    });
};
 ...
 */
export const addImessageGroupParticipant = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AddImessageGroupParticipantData, ThrowOnError>) => {
    return (options?.client ?? client).post<AddImessageGroupParticipantResponse, AddImessageGroupParticipantError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/groups/{conversationId}/participants'
    });
};
 ...
 */
export const removeImessageGroupParticipant = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RemoveImessageGroupParticipantData, ThrowOnError>) => {
    return (options?.client ?? client).delete<RemoveImessageGroupParticipantResponse, RemoveImessageGroupParticipantError, ThrowOnError>({
        ...options,
        url: '/v1/imessage/groups/{conversationId}/participants'
    });
};
 ...
 */
export const linkWhatsAppCatalog = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<LinkWhatsAppCatalogData, ThrowOnError>) => {
    return (options?.client ?? client).post<LinkWhatsAppCatalogResponse, LinkWhatsAppCatalogError, ThrowOnError>({
        ...options,
        url: '/v1/whatsapp/catalogs'
    });
};
 ...
 */
export const unlinkWhatsAppCatalog = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UnlinkWhatsAppCatalogData, ThrowOnError>) => {
    return (options?.client ?? client).delete<UnlinkWhatsAppCatalogResponse, UnlinkWhatsAppCatalogError, ThrowOnError>({
        ...options,
        url: '/v1/whatsapp/catalogs'
    });
};
 ...
 */
export const getWhatsAppCommerceSettings = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetWhatsAppCommerceSettingsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetWhatsAppCommerceSettingsResponse, GetWhatsAppCommerceSettingsError, ThrowOnError>({
        ...options,
 ...
 */
export const updateWhatsAppCommerceSettings = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateWhatsAppCommerceSettingsData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateWhatsAppCommerceSettingsResponse, UpdateWhatsAppCommerceSettingsError, ThrowOnError>({
        ...options,
        url: '/v1/whatsapp/commerce-settings'
    });
};
 ...
 *
 */
export const listWhatsAppAccountEvents = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListWhatsAppAccountEventsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListWhatsAppAccountEventsResponse, ListWhatsAppAccountEventsError, ThrowOnError>({
        ...options,
        url: '/v1/whatsapp/account-events'
    });
};
 ...
 *
 */
export const getPhoneNumberClaim = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetPhoneNumberClaimData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetPhoneNumberClaimResponse, GetPhoneNumberClaimError, ThrowOnError>({
        ...options,
        url: '/v1/phone-numbers/claims/{claimId}'
    });
};
 ...
 *
 */
export const getPhoneNumberPortClaim = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetPhoneNumberPortClaimData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetPhoneNumberPortClaimResponse, GetPhoneNumberPortClaimError, ThrowOnError>({
        ...options,
        url: '/v1/phone-numbers/port-in/claims/{claimId}'
    });
};
...
export const createPhoneNumberStockWatch = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreatePhoneNumberStockWatchData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreatePhoneNumberStockWatchResponse, CreatePhoneNumberStockWatchError, ThrowOnError>({
        ...options,
        url: '/v1/phone-numbers/stock-watches'
    });
};
 ...
 * List stock watches
 */
export const listPhoneNumberStockWatches = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<ListPhoneNumberStockWatchesResponse, ListPhoneNumberStockWatchesError, ThrowOnError>({
        ...options,
        url: '/v1/phone-numbers/stock-watches'
    });
};
 ...
 */
export const deletePhoneNumberStockWatch = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeletePhoneNumberStockWatchData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeletePhoneNumberStockWatchResponse, DeletePhoneNumberStockWatchError, ThrowOnError>({
        ...options,
        url: '/v1/phone-numbers/stock-watches/{id}'
    });
};
 ...
 *
 */
export const createSipTrunk = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateSipTrunkData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateSipTrunkResponse, CreateSipTrunkError, ThrowOnError>({
        ...options,
        url: '/v1/phone-numbers/sip-trunks'
    });
};
 ...
 * List SIP trunks
 */
export const listSipTrunks = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
 ...
 * Get a SIP trunk
 */
export const getSipTrunk = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetSipTrunkData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetSipTrunkResponse, GetSipTrunkError, ThrowOnError>({
        ...options,
        url: '/v1/phone-numbers/sip-trunks/{id}'
    });
};
 ...
 *
 */
export const deleteSipTrunk = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteSipTrunkData, ThrowOnError>) => {
 ...
 *
 */
export const rotateSipTrunkCredentials = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RotateSipTrunkCredentialsData, ThrowOnError>) => {
    return (options?.client ?? client).post<RotateSipTrunkCredentialsResponse, RotateSipTrunkCredentialsError, ThrowOnError>({
        ...options,
        url: '/v1/phone-numbers/sip-trunks/{id}/rotate-credentials'
    });
};
 ...
 *
 */
export const attachNumberToSipTrunk = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AttachNumberToSipTrunkData, ThrowOnError>) => {
    return (options?.client ?? client).post<AttachNumberToSipTrunkResponse, AttachNumberToSipTrunkError, ThrowOnError>({
        ...options,
        url: '/v1/phone-numbers/{id}/sip-trunk'
    });
};
 ...
 *
 */
export const detachNumberFromSipTrunk = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DetachNumberFromSipTrunkData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DetachNumberFromSipTrunkResponse, DetachNumberFromSipTrunkError, ThrowOnError>({
        ...options,
        url: '/v1/phone-numbers/{id}/sip-trunk'
    });
};
 ...
 *
 */
export const getWhatsAppFlowsEncryptionKey = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetWhatsAppFlowsEncryptionKeyData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetWhatsAppFlowsEncryptionKeyResponse, GetWhatsAppFlowsEncryptionKeyError, ThrowOnError>({
        ...options,
        url: '/v1/whatsapp/flows/encryption-key'
    });
};
 ...
 *
 */
export const setWhatsAppFlowsEncryptionKey = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SetWhatsAppFlowsEncryptionKeyData, ThrowOnError>) => {
    return (options?.client ?? client).post<SetWhatsAppFlowsEncryptionKeyResponse, SetWhatsAppFlowsEncryptionKeyError, ThrowOnError>({
        ...options,
        url: '/v1/whatsapp/flows/encryption-key'
    });
};
 ...
 */
export const createBidStrategy = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateBidStrategyData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateBidStrategyResponse, CreateBidStrategyError, ThrowOnError>({
        ...options,
        url: '/v1/ads/bid-strategies'
    });
};
 ...
 */
export const updateBidStrategy = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateBidStrategyData, ThrowOnError>) => {
    return (options?.client ?? client).patch<UpdateBidStrategyResponse, UpdateBidStrategyError, ThrowOnError>({
        ...options,
        url: '/v1/ads/bid-strategies/{strategyId}'
    });
};
 ...
 *
 */
export const addAdKeywords = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AddAdKeywordsData, ThrowOnError>) => {
    return (options?.client ?? client).post<AddAdKeywordsResponse, AddAdKeywordsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/keywords'
    });
};
 ...
 *
 */
export const updateAdKeyword = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateAdKeywordData, ThrowOnError>) => {
    return (options?.client ?? client).patch<UpdateAdKeywordResponse, UpdateAdKeywordError, ThrowOnError>({
        ...options,
        url: '/v1/ads/keywords/{keywordId}'
    });
};
 ...
 */
export const removeAdKeyword = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RemoveAdKeywordData, ThrowOnError>) => {
    return (options?.client ?? client).delete<RemoveAdKeywordResponse, RemoveAdKeywordError, ThrowOnError>({
        ...options,
        url: '/v1/ads/keywords/{keywordId}'
    });
};
 ...
 *
 */
export const getCampaignAdSchedule = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetCampaignAdScheduleData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetCampaignAdScheduleResponse, GetCampaignAdScheduleError, ThrowOnError>({
        ...options,
        url: '/v1/ads/campaigns/{campaignId}/ad-schedule'
    });
};
 ...
 *
 */
export const updateCampaignAdSchedule = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateCampaignAdScheduleData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateCampaignAdScheduleResponse, UpdateCampaignAdScheduleError, ThrowOnError>({
        ...options,
        url: '/v1/ads/campaigns/{campaignId}/ad-schedule'
    });
};
 ...
 *
 */
export const getCampaignBidding = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetCampaignBiddingData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetCampaignBiddingResponse, GetCampaignBiddingError, ThrowOnError>({
        ...options,
        url: '/v1/ads/campaigns/{campaignId}/bidding'
    });
};
 ...
 */
export const getAdCampaignDetails = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetAdCampaignDetailsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAdCampaignDetailsResponse, GetAdCampaignDetailsError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const listCampaignNegativeKeywords = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListCampaignNegativeKeywordsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListCampaignNegativeKeywordsResponse, ListCampaignNegativeKeywordsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/campaigns/{campaignId}/negative-keywords'
    });
};
 ...
 *
 */
export const replaceCampaignNegativeKeywords = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ReplaceCampaignNegativeKeywordsData, ThrowOnError>) => {
    return (options?.client ?? client).put<ReplaceCampaignNegativeKeywordsResponse, ReplaceCampaignNegativeKeywordsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/campaigns/{campaignId}/negative-keywords'
    });
};
...
export const getCampaignTargeting = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetCampaignTargetingData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetCampaignTargetingResponse, GetCampaignTargetingError, ThrowOnError>({
        ...options,
        url: '/v1/ads/campaigns/{campaignId}/targeting'
    });
};
 ...
 * **Idempotency:** send an `Idempotency-Key` header to make retries safe.
 */
export const createAdSet = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateAdSetData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateAdSetResponse, CreateAdSetError, ThrowOnError>({
        ...options,
        url: '/v1/ads/ad-sets'
    });
};
 ...
 *
 */
export const deleteAdSet = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteAdSetData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteAdSetResponse, DeleteAdSetError, ThrowOnError>({
        ...options,
        url: '/v1/ads/ad-sets/{adSetId}'
    });
};
 ...
 */
export const listCampaignAssets = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListCampaignAssetsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListCampaignAssetsResponse, ListCampaignAssetsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/campaigns/{campaignId}/assets'
    });
};
 ...
 */
export const updateCampaignAssets = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateCampaignAssetsData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateCampaignAssetsResponse, UpdateCampaignAssetsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/campaigns/{campaignId}/assets'
    });
};
 ...
 * Lists directly attached Google assets. Fresh reads are cached for 10 minutes; exhausted quota may return the last successful read with stale=true. Inherited assets are not included.
 */
export const listAdGroupAssets = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAdGroupAssetsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAdGroupAssetsResponse, ListAdGroupAssetsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/ad-sets/{adSetId}/assets'
    });
};
 ...
 * Edits existing Google assets in place. Send updates with assetResourceName and the fields to change. An asset is shared: changes affect every attachment using it. Omitted fields stay unchanged. The operation consumes the Google operations budget and invalidates affected cached lists.
 */
export const updateAdGroupAssets = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateAdGroupAssetsData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateAdGroupAssetsResponse, UpdateAdGroupAssetsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/ad-sets/{adSetId}/assets'
    });
};
 ...
 */
export const getAdMedia = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetAdMediaData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAdMediaResponse, GetAdMediaError, ThrowOnError>({
        ...options,
        url: '/v1/ads/{adId}/media'
    });
};
 ...
 *
 */
export const replyToAdComment = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ReplyToAdCommentData, ThrowOnError>) => {
    return (options?.client ?? client).post<ReplyToAdCommentResponse, ReplyToAdCommentError, ThrowOnError>({
        ...options,
        url: '/v1/ads/{adId}/comments/{commentId}/reply'
    });
};
 ...
 *
 */
export const hideAdComment = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<HideAdCommentData, ThrowOnError>) => {
    return (options?.client ?? client).post<HideAdCommentResponse, HideAdCommentError, ThrowOnError>({
        ...options,
        url: '/v1/ads/{adId}/comments/{commentId}/hide'
    });
};
 ...
 *
 */
export const deleteAdComment = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteAdCommentData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteAdCommentResponse, DeleteAdCommentError, ThrowOnError>({
        ...options,
        url: '/v1/ads/{adId}/comments/{commentId}'
    });
};
 ...
 */
export const listAdsTikTokIdentities = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAdsTikTokIdentitiesData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAdsTikTokIdentitiesResponse, ListAdsTikTokIdentitiesError, ThrowOnError>({
        ...options,
        url: '/v1/ads/tiktok-identities'
    });
};
...
export const getTikTokSmartPlusMaterialReport = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetTikTokSmartPlusMaterialReportData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetTikTokSmartPlusMaterialReportResponse, GetTikTokSmartPlusMaterialReportError, ThrowOnError>({
        ...options,
        url: '/v1/ads/tiktok-smart-plus-materials'
    });
};
 ...
 */
export const listAdsInstagramAccounts = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAdsInstagramAccountsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAdsInstagramAccountsResponse, ListAdsInstagramAccountsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/instagram-accounts'
    });
};
 ...
 */
export const listAdsInstagramPosts = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAdsInstagramPostsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAdsInstagramPostsResponse, ListAdsInstagramPostsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/instagram-posts'
    });
};
 ...
 */
export const listAdvertisableApplications = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAdvertisableApplicationsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAdvertisableApplicationsResponse, ListAdvertisableApplicationsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/advertisable-applications'
    });
};
 ...
 */
export const getIosFourteenCampaignLimits = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetIosFourteenCampaignLimitsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetIosFourteenCampaignLimitsResponse, GetIosFourteenCampaignLimitsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/ios-fourteen-campaign-limits'
    });
};
 ...
 */
export const listAdNegativeKeywordLists = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAdNegativeKeywordListsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAdNegativeKeywordListsResponse, ListAdNegativeKeywordListsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/negative-keyword-lists'
    });
};
 ...
 */
export const createAdNegativeKeywordList = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateAdNegativeKeywordListData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateAdNegativeKeywordListResponse, CreateAdNegativeKeywordListError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/negative-keyword-lists'
    });
};
 ...
 */
export const getAdNegativeKeywordList = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetAdNegativeKeywordListData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAdNegativeKeywordListResponse, GetAdNegativeKeywordListError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/negative-keyword-lists/{listId}'
    });
};
 ...
 */
export const updateAdNegativeKeywordList = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateAdNegativeKeywordListData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateAdNegativeKeywordListResponse, UpdateAdNegativeKeywordListError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/negative-keyword-lists/{listId}'
    });
};
 ...
 */
export const deleteAdNegativeKeywordList = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteAdNegativeKeywordListData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteAdNegativeKeywordListResponse, DeleteAdNegativeKeywordListError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/negative-keyword-lists/{listId}'
    });
};
 ...
 */
export const replaceAdNegativeKeywordListKeywords = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ReplaceAdNegativeKeywordListKeywordsData, ThrowOnError>) => {
    return (options?.client ?? client).put<ReplaceAdNegativeKeywordListKeywordsResponse, ReplaceAdNegativeKeywordListKeywordsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/negative-keyword-lists/{listId}/keywords'
    });
};
 ...
 */
export const listCampaignNegativeKeywordLists = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListCampaignNegativeKeywordListsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListCampaignNegativeKeywordListsResponse, ListCampaignNegativeKeywordListsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/campaigns/{campaignId}/negative-keyword-lists'
    });
};
 ...
 */
export const replaceCampaignNegativeKeywordLists = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ReplaceCampaignNegativeKeywordListsData, ThrowOnError>) => {
    return (options?.client ?? client).put<ReplaceCampaignNegativeKeywordListsResponse, ReplaceCampaignNegativeKeywordListsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/campaigns/{campaignId}/negative-keyword-lists'
    });
};
 ...
 */
export const addAccountCallouts = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AddAccountCalloutsData, ThrowOnError>) => {
    return (options?.client ?? client).post<AddAccountCalloutsResponse, AddAccountCalloutsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/callouts'
    });
};
 ...
 * Edits existing Google assets in place. Send updates with assetResourceName and the fields to change. An asset is shared: changes affect every attachment using it. Omitted fields stay unchanged. The operation consumes the Google operations budget and invalidates affected cached lists.
 */
export const updateAccountCallouts = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateAccountCalloutsData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateAccountCalloutsResponse, UpdateAccountCalloutsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/callouts'
    });
};
 ...
 * Lists directly attached Google assets. Fresh reads are cached for 10 minutes; exhausted quota may return the last successful read with stale=true. Inherited assets are not included.
 */
export const listAccountSitelinks = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAccountSitelinksData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAccountSitelinksResponse, ListAccountSitelinksError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/sitelinks'
    });
};
 ...
 * Creates assets and customer_asset links for this Google customer. Links apply at account level.
 */
export const addAccountSitelinks = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AddAccountSitelinksData, ThrowOnError>) => {
    return (options?.client ?? client).post<AddAccountSitelinksResponse, AddAccountSitelinksError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/sitelinks'
    });
};
 ...
 * Edits existing Google assets in place. Send updates with assetResourceName and the fields to change. An asset is shared: changes affect every attachment using it. Omitted fields stay unchanged. The operation consumes the Google operations budget and invalidates affected cached lists.
 */
export const updateAccountSitelinks = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateAccountSitelinksData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateAccountSitelinksResponse, UpdateAccountSitelinksError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/sitelinks'
    });
};
 ...
 * Lists directly attached Google assets. Fresh reads are cached for 10 minutes; exhausted quota may return the last successful read with stale=true. Inherited assets are not included.
 */
export const listAccountStructuredSnippets = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAccountStructuredSnippetsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAccountStructuredSnippetsResponse, ListAccountStructuredSnippetsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/structured-snippets'
    });
};
 ...
 * Creates assets and customer_asset links for this Google customer. Links apply at account level.
 */
export const addAccountStructuredSnippets = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AddAccountStructuredSnippetsData, ThrowOnError>) => {
    return (options?.client ?? client).post<AddAccountStructuredSnippetsResponse, AddAccountStructuredSnippetsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/structured-snippets'
    });
};
 ...
 * Edits existing Google assets in place. Send updates with assetResourceName and the fields to change. An asset is shared: changes affect every attachment using it. Omitted fields stay unchanged. The operation consumes the Google operations budget and invalidates affected cached lists.
 */
export const updateAccountStructuredSnippets = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateAccountStructuredSnippetsData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateAccountStructuredSnippetsResponse, UpdateAccountStructuredSnippetsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts/structured-snippets'
    });
};
 ...
 *
 */
export const createAdAccount = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateAdAccountData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateAdAccountResponse, CreateAdAccountError, ThrowOnError>({
        ...options,
        url: '/v1/ads/accounts'
    });
};
 ...
 */
export const listGoogleAssetGroups = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListGoogleAssetGroupsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListGoogleAssetGroupsResponse, ListGoogleAssetGroupsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/campaigns/{campaignId}/asset-groups'
    });
};
 ...
 *
 */
export const deleteTestLead = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteTestLeadData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteTestLeadResponse, DeleteTestLeadError, ThrowOnError>({
        ...options,
        url: '/v1/ads/lead-forms/{formId}/test-leads'
    });
};
 ...
 * 800 s).
 */
export const uploadAdVideo = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UploadAdVideoData, ThrowOnError>) => {
    return (options?.client ?? client).post<UploadAdVideoResponse, UploadAdVideoError, ThrowOnError>({
        ...options,
        url: '/v1/ads/videos'
    });
};
 ...
 */
export const listAdVideos = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAdVideosData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAdVideosResponse, ListAdVideosError, ThrowOnError>({
        ...options,
        url: '/v1/ads/videos'
    });
};
 ...
 */
export const deleteAdVideo = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteAdVideoData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteAdVideoResponse, DeleteAdVideoError, ThrowOnError>({
        ...options,
        url: '/v1/ads/videos/{videoId}'
    });
};
 ...
 */
export const createAdCatalog = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateAdCatalogData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateAdCatalogResponse, CreateAdCatalogError, ThrowOnError>({
        ...options,
        url: '/v1/ads/catalogs'
    });
};
 ...
 */
export const getAdCatalog = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetAdCatalogData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAdCatalogResponse, GetAdCatalogError, ThrowOnError>({
        ...options,
 ...
 */
export const deleteAdCatalog = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteAdCatalogData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteAdCatalogResponse, DeleteAdCatalogError, ThrowOnError>({
        ...options,
        url: '/v1/ads/catalogs/{catalogId}'
    });
};
 ...
 */
export const listAdCatalogProducts = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAdCatalogProductsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAdCatalogProductsResponse, ListAdCatalogProductsError, ThrowOnError>({
        ...options,
 ...
 */
export const createAdCatalogProduct = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateAdCatalogProductData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateAdCatalogProductResponse, CreateAdCatalogProductError, ThrowOnError>({
        ...options,
        url: '/v1/ads/catalogs/{catalogId}/products'
    });
};
 ...
 */
export const batchAdCatalogProducts = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<BatchAdCatalogProductsData, ThrowOnError>) => {
    return (options?.client ?? client).post<BatchAdCatalogProductsResponse, BatchAdCatalogProductsError, ThrowOnError>({
        ...options,
 ...
 */
export const getAdCatalogBatch = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetAdCatalogBatchData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAdCatalogBatchResponse, GetAdCatalogBatchError, ThrowOnError>({
        ...options,
 ...
 * Get a product
 */
export const getAdCatalogProduct = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetAdCatalogProductData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAdCatalogProductResponse, GetAdCatalogProductError, ThrowOnError>({
        ...options,
 ...
 */
export const updateAdCatalogProduct = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateAdCatalogProductData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateAdCatalogProductResponse, UpdateAdCatalogProductError, ThrowOnError>({
        ...options,
        url: '/v1/ads/catalogs/{catalogId}/products/{productId}'
    });
};
 ...
 * Delete a product
 */
export const deleteAdCatalogProduct = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteAdCatalogProductData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteAdCatalogProductResponse, DeleteAdCatalogProductError, ThrowOnError>({
        ...options,
        url: '/v1/ads/catalogs/{catalogId}/products/{productId}'
    });
};
 ...
 */
export const listAdCatalogFeeds = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAdCatalogFeedsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAdCatalogFeedsResponse, ListAdCatalogFeedsError, ThrowOnError>({
        ...options,
 ...
 */
export const createAdCatalogFeed = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateAdCatalogFeedData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateAdCatalogFeedResponse, CreateAdCatalogFeedError, ThrowOnError>({
        ...options,
        url: '/v1/ads/catalogs/{catalogId}/feeds'
    });
};
 ...
 */
export const listAdCatalogFeedUploads = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAdCatalogFeedUploadsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAdCatalogFeedUploadsResponse, ListAdCatalogFeedUploadsError, ThrowOnError>({
        ...options,
 ...
 */
export const createAdCatalogFeedUpload = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateAdCatalogFeedUploadData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateAdCatalogFeedUploadResponse, CreateAdCatalogFeedUploadError, ThrowOnError>({
        ...options,
        url: '/v1/ads/catalogs/{catalogId}/feeds/{feedId}/uploads'
    });
};
 ...
 */
export const createAdCatalogProductSet = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateAdCatalogProductSetData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateAdCatalogProductSetResponse, CreateAdCatalogProductSetError, ThrowOnError>({
        ...options,
        url: '/v1/ads/catalogs/{catalogId}/product-sets'
    });
};
 ...
 */
export const updateAdCatalogProductSet = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateAdCatalogProductSetData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateAdCatalogProductSetResponse, UpdateAdCatalogProductSetError, ThrowOnError>({
        ...options,
 ...
 */
export const deleteAdCatalogProductSet = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteAdCatalogProductSetData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteAdCatalogProductSetResponse, DeleteAdCatalogProductSetError, ThrowOnError>({
        ...options,
        url: '/v1/ads/catalogs/{catalogId}/product-sets/{productSetId}'
    });
};
 ...
 *
 */
export const replaceAdAudienceCompanies = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ReplaceAdAudienceCompaniesData, ThrowOnError>) => {
    return (options?.client ?? client).post<ReplaceAdAudienceCompaniesResponse, ReplaceAdAudienceCompaniesError, ThrowOnError>({
        ...options,
        url: '/v1/ads/audiences/{audienceId}/companies'
    });
};
...
export const listConversionActions = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListConversionActionsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListConversionActionsResponse, ListConversionActionsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/conversions/actions'
    });
};
...
export const createConversionAction = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateConversionActionData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateConversionActionResponse, CreateConversionActionError, ThrowOnError>({
        ...options,
        url: '/v1/ads/conversions/actions'
    });
};
 ...
 *
 */
export const getBusinessAgentStatus = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBusinessAgentStatusData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBusinessAgentStatusResponse, GetBusinessAgentStatusError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent'
    });
};
 ...
 *
 */
export const onboardBusinessAgent = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<OnboardBusinessAgentData, ThrowOnError>) => {
    return (options?.client ?? client).post<OnboardBusinessAgentResponse, OnboardBusinessAgentError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/onboard'
    });
};
 ...
 */
export const listBusinessAgentSettings = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListBusinessAgentSettingsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListBusinessAgentSettingsResponse, ListBusinessAgentSettingsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/settings'
    });
};
 ...
 *
 */
export const updateBusinessAgentSettings = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateBusinessAgentSettingsData, ThrowOnError>) => {
    return (options?.client ?? client).patch<UpdateBusinessAgentSettingsResponse, UpdateBusinessAgentSettingsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/settings'
    });
};
 ...
 */
export const listBusinessAgentAllowlist = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListBusinessAgentAllowlistData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListBusinessAgentAllowlistResponse, ListBusinessAgentAllowlistError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/allowlist'
    });
};
 ...
 */
export const addBusinessAgentAllowlistEntry = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AddBusinessAgentAllowlistEntryData, ThrowOnError>) => {
    return (options?.client ?? client).post<AddBusinessAgentAllowlistEntryResponse, AddBusinessAgentAllowlistEntryError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/allowlist'
    });
};
 ...
 */
export const removeBusinessAgentAllowlistEntry = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RemoveBusinessAgentAllowlistEntryData, ThrowOnError>) => {
    return (options?.client ?? client).delete<RemoveBusinessAgentAllowlistEntryResponse, RemoveBusinessAgentAllowlistEntryError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/allowlist/{entryId}'
    });
};
 ...
 */
export const getBusinessAgentBusinessInformation = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBusinessAgentBusinessInformationData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBusinessAgentBusinessInformationResponse, GetBusinessAgentBusinessInformationError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/business-information'
    });
};
 ...
 */
export const replaceBusinessAgentBusinessInformation = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ReplaceBusinessAgentBusinessInformationData, ThrowOnError>) => {
    return (options?.client ?? client).put<ReplaceBusinessAgentBusinessInformationResponse, ReplaceBusinessAgentBusinessInformationError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/business-information'
    });
};
 ...
 */
export const resetBusinessAgentBusinessInformation = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ResetBusinessAgentBusinessInformationData, ThrowOnError>) => {
    return (options?.client ?? client).delete<ResetBusinessAgentBusinessInformationResponse, ResetBusinessAgentBusinessInformationError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/business-information'
    });
};
 ...
 * List FAQs
 */
export const listBusinessAgentFaqs = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListBusinessAgentFaqsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListBusinessAgentFaqsResponse, ListBusinessAgentFaqsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/faqs'
    });
};
 ...
 */
export const createBusinessAgentFaq = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateBusinessAgentFaqData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateBusinessAgentFaqResponse, CreateBusinessAgentFaqError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/faqs'
    });
};
 ...
 * Get a FAQ
 */
export const getBusinessAgentFaq = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBusinessAgentFaqData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBusinessAgentFaqResponse, GetBusinessAgentFaqError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/faqs/{faqId}'
    });
};
 ...
 * Update a FAQ
 */
export const updateBusinessAgentFaq = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateBusinessAgentFaqData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateBusinessAgentFaqResponse, UpdateBusinessAgentFaqError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/faqs/{faqId}'
    });
};
 ...
 * Delete a FAQ
 */
export const deleteBusinessAgentFaq = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteBusinessAgentFaqData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteBusinessAgentFaqResponse, DeleteBusinessAgentFaqError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/faqs/{faqId}'
    });
};
 ...
 */
export const listBusinessAgentWebsites = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListBusinessAgentWebsitesData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListBusinessAgentWebsitesResponse, ListBusinessAgentWebsitesError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/websites'
    });
};
 ...
 */
export const addBusinessAgentWebsite = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AddBusinessAgentWebsiteData, ThrowOnError>) => {
    return (options?.client ?? client).post<AddBusinessAgentWebsiteResponse, AddBusinessAgentWebsiteError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/websites'
    });
};
 ...
 */
export const getBusinessAgentWebsite = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBusinessAgentWebsiteData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBusinessAgentWebsiteResponse, GetBusinessAgentWebsiteError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/websites/{websiteId}'
    });
};
 ...
 */
export const updateBusinessAgentWebsite = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateBusinessAgentWebsiteData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateBusinessAgentWebsiteResponse, UpdateBusinessAgentWebsiteError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/websites/{websiteId}'
    });
};
 ...
 */
export const deleteBusinessAgentWebsite = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteBusinessAgentWebsiteData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteBusinessAgentWebsiteResponse, DeleteBusinessAgentWebsiteError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/websites/{websiteId}'
    });
};
 ...
 */
export const listBusinessAgentFiles = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListBusinessAgentFilesData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListBusinessAgentFilesResponse, ListBusinessAgentFilesError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/files'
    });
};
 ...
 *
 */
export const uploadBusinessAgentFile = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UploadBusinessAgentFileData, ThrowOnError>) => {
    return (options?.client ?? client).post<UploadBusinessAgentFileResponse, UploadBusinessAgentFileError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/files'
    });
};
 ...
 */
export const getBusinessAgentFile = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBusinessAgentFileData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBusinessAgentFileResponse, GetBusinessAgentFileError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/files/{fileId}'
    });
};
 ...
 */
export const deleteBusinessAgentFile = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteBusinessAgentFileData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteBusinessAgentFileResponse, DeleteBusinessAgentFileError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/files/{fileId}'
    });
};
 ...
 * List skills
 */
export const listBusinessAgentSkills = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListBusinessAgentSkillsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListBusinessAgentSkillsResponse, ListBusinessAgentSkillsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/skills'
    });
};
 ...
 */
export const createBusinessAgentSkill = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateBusinessAgentSkillData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateBusinessAgentSkillResponse, CreateBusinessAgentSkillError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/skills'
    });
};
 ...
 * Get a skill
 */
export const getBusinessAgentSkill = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBusinessAgentSkillData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBusinessAgentSkillResponse, GetBusinessAgentSkillError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/skills/{skillId}'
    });
};
 ...
 * Update a skill
 */
export const updateBusinessAgentSkill = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateBusinessAgentSkillData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateBusinessAgentSkillResponse, UpdateBusinessAgentSkillError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/skills/{skillId}'
    });
};
 ...
 * Delete a skill
 */
export const deleteBusinessAgentSkill = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteBusinessAgentSkillData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteBusinessAgentSkillResponse, DeleteBusinessAgentSkillError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/skills/{skillId}'
    });
};
 ...
 */
export const listBusinessAgentUiSkills = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListBusinessAgentUiSkillsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListBusinessAgentUiSkillsResponse, ListBusinessAgentUiSkillsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/ui-skills'
    });
};
 ...
 */
export const createBusinessAgentUiSkill = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateBusinessAgentUiSkillData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateBusinessAgentUiSkillResponse, CreateBusinessAgentUiSkillError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/ui-skills'
    });
};
 ...
 * Get a UI skill
 */
export const getBusinessAgentUiSkill = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBusinessAgentUiSkillData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBusinessAgentUiSkillResponse, GetBusinessAgentUiSkillError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/ui-skills/{uiSkillId}'
    });
};
 ...
 * Update a UI skill
 */
export const updateBusinessAgentUiSkill = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateBusinessAgentUiSkillData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateBusinessAgentUiSkillResponse, UpdateBusinessAgentUiSkillError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/ui-skills/{uiSkillId}'
    });
};
 ...
 * Delete a UI skill
 */
export const deleteBusinessAgentUiSkill = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteBusinessAgentUiSkillData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteBusinessAgentUiSkillResponse, DeleteBusinessAgentUiSkillError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/ui-skills/{uiSkillId}'
    });
};
 ...
 */
export const listBusinessAgentConnectors = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListBusinessAgentConnectorsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListBusinessAgentConnectorsResponse, ListBusinessAgentConnectorsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors'
    });
};
 ...
 */
export const createBusinessAgentConnector = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateBusinessAgentConnectorData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateBusinessAgentConnectorResponse, CreateBusinessAgentConnectorError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors'
    });
};
 ...
 * Get a connector
 */
export const getBusinessAgentConnector = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBusinessAgentConnectorData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBusinessAgentConnectorResponse, GetBusinessAgentConnectorError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors/{connectorId}'
    });
};
 ...
 * Update a connector
 */
export const updateBusinessAgentConnector = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateBusinessAgentConnectorData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateBusinessAgentConnectorResponse, UpdateBusinessAgentConnectorError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors/{connectorId}'
    });
};
 ...
 * Delete a connector
 */
export const deleteBusinessAgentConnector = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteBusinessAgentConnectorData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteBusinessAgentConnectorResponse, DeleteBusinessAgentConnectorError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors/{connectorId}'
    });
};
 ...
 *
 */
export const setBusinessAgentConnectorCredentials = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SetBusinessAgentConnectorCredentialsData, ThrowOnError>) => {
    return (options?.client ?? client).post<SetBusinessAgentConnectorCredentialsResponse, SetBusinessAgentConnectorCredentialsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors/{connectorId}/credentials'
    });
};
 ...
 */
export const refreshBusinessAgentConnectorTools = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RefreshBusinessAgentConnectorToolsData, ThrowOnError>) => {
    return (options?.client ?? client).post<RefreshBusinessAgentConnectorToolsResponse, RefreshBusinessAgentConnectorToolsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors/{connectorId}/refresh-tools'
    });
};
 ...
 */
export const getBusinessAgentConnectorLogs = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBusinessAgentConnectorLogsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBusinessAgentConnectorLogsResponse, GetBusinessAgentConnectorLogsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors/{connectorId}/logs'
    });
};
 ...
 */
export const listBusinessAgentConnectorTools = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListBusinessAgentConnectorToolsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListBusinessAgentConnectorToolsResponse, ListBusinessAgentConnectorToolsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors/{connectorId}/tools'
    });
};
 ...
 */
export const createBusinessAgentConnectorTool = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateBusinessAgentConnectorToolData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateBusinessAgentConnectorToolResponse, CreateBusinessAgentConnectorToolError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors/{connectorId}/tools'
    });
};
 ...
 */
export const getBusinessAgentConnectorTool = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBusinessAgentConnectorToolData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBusinessAgentConnectorToolResponse, GetBusinessAgentConnectorToolError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors/{connectorId}/tools/{toolId}'
    });
};
 ...
 */
export const updateBusinessAgentConnectorTool = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateBusinessAgentConnectorToolData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateBusinessAgentConnectorToolResponse, UpdateBusinessAgentConnectorToolError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors/{connectorId}/tools/{toolId}'
    });
};
 ...
 */
export const deleteBusinessAgentConnectorTool = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteBusinessAgentConnectorToolData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteBusinessAgentConnectorToolResponse, DeleteBusinessAgentConnectorToolError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors/{connectorId}/tools/{toolId}'
    });
};
 ...
 */
export const runBusinessAgentConnectorTool = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RunBusinessAgentConnectorToolData, ThrowOnError>) => {
    return (options?.client ?? client).post<RunBusinessAgentConnectorToolResponse, RunBusinessAgentConnectorToolError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/connectors/{connectorId}/tools/{toolId}/run'
    });
};
 ...
 */
export const getBusinessAgentBudget = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBusinessAgentBudgetData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBusinessAgentBudgetResponse, GetBusinessAgentBudgetError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/budget'
    });
};
 ...
 */
export const replaceBusinessAgentBudget = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ReplaceBusinessAgentBudgetData, ThrowOnError>) => {
    return (options?.client ?? client).put<ReplaceBusinessAgentBudgetResponse, ReplaceBusinessAgentBudgetError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/budget'
    });
};
 ...
 */
export const sendBusinessAgentTestMessage = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SendBusinessAgentTestMessageData, ThrowOnError>) => {
    return (options?.client ?? client).post<SendBusinessAgentTestMessageResponse, SendBusinessAgentTestMessageError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/test-messages'
    });
};
 ...
 */
export const sendBusinessAgentEvent = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SendBusinessAgentEventData, ThrowOnError>) => {
    return (options?.client ?? client).post<SendBusinessAgentEventResponse, SendBusinessAgentEventError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/events'
    });
};
 ...
 */
export const getBusinessAgentEvent = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetBusinessAgentEventData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBusinessAgentEventResponse, GetBusinessAgentEventError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/events/{eventId}'
    });
};
 ...
 *
 */
export const readBusinessAgentEvals = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ReadBusinessAgentEvalsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ReadBusinessAgentEvalsResponse, ReadBusinessAgentEvalsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/evals'
    });
};
 ...
 */
export const startBusinessAgentEvalRun = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<StartBusinessAgentEvalRunData, ThrowOnError>) => {
    return (options?.client ?? client).post<StartBusinessAgentEvalRunResponse, StartBusinessAgentEvalRunError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/business-agent/evals'
    });
};
...
export const listProducts = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListProductsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListProductsResponse, ListProductsError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/products'
    });
};
...
export const getProduct = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetProductData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetProductResponse, GetProductError, ThrowOnError>({
        ...options,
        url: '/v1/accounts/{accountId}/products/{productId}'
    });
};
 ...
 */
export const listTikTokAdPixels = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListTikTokAdPixelsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListTikTokAdPixelsResponse, ListTikTokAdPixelsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/pixels'
    });
};
 ...
 */
export const listPartnershipAdContent = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListPartnershipAdContentData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListPartnershipAdContentResponse, ListPartnershipAdContentError, ThrowOnError>({
        ...options,
        url: '/v1/ads/partnership-content'
    });
};
 ...
 */
export const listPartnershipAdPermissions = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListPartnershipAdPermissionsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListPartnershipAdPermissionsResponse, ListPartnershipAdPermissionsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/partnership-permissions'
    });
};
 ...
 */
export const setPartnershipAdPermission = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SetPartnershipAdPermissionData, ThrowOnError>) => {
    return (options?.client ?? client).post<SetPartnershipAdPermissionResponse, SetPartnershipAdPermissionError, ThrowOnError>({
        ...options,
        url: '/v1/ads/partnership-permissions'
    });
};
