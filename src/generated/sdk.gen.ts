 ...
 */
export const syncExternalAds = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).post<SyncExternalAdsResponse, SyncExternalAdsError, ThrowOnError>({
        ...options,
        url: '/v1/ads/sync'
    });
};
